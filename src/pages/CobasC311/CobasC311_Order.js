    ...
    },
    {
        ...
        render: order => {
            if (order.transaction_code !== null) {
                var link = '/cobas-c-311/result/' + order.sample_id
                return (
                    <Link to={link} >
...
export default class CobasC311_Order extends Component {
    constructor(props) {
        super(props)
        this.state = {
            dataSource: null
    ...
    componentDidMount() {
        fetch(Config.server_mirth + 'device-order?device-id=3')
