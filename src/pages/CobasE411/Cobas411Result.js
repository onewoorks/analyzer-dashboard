...
export default class Cobas411Result extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    fetch_result() {
        console.log(Config.server_mirth + 'result?lis_lab_id=' + this.state.match.params.lis_test_id)
        ...
        return (
            <React.Fragment>
                <Row gutter={16}>
                    ...
                    <Col span={16}>
                        <Card title="Cobas E 411 Result" bordered={true} headStyle={{ backgroundColor: '#f2f4f5' }}>
                            {this.result_slip()}
